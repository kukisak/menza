...
%>	
	...
	<form action="/editReservation" method="post">
    	    ...
    	    <tr><th>User ID</th>	<td>	<input type="text" name="userID" value="<%= editReservation.getUserID()%>" />			</td></tr>        
	    	...
	    	<tr><th>Day and time To</th>		<td>	<input type="text" name="dateEnd" value="<% 
	      	...
	      	<tr><th>Price(Kc)</th>	<td>	<input type="text" name="price" value="<%= editReservation.getPrice()%>" />			</td></tr>	      	
...
<%	   
    String query = "select from " + Reservation.class.getName() + " order by dateStart";
